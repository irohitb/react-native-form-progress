...
const ProgressBar = ({ defaultProgress, colorOfNonProgressBar = 'white', colorOfProgressBar = 'black', heightOfProgressBar = 5, SafeAreaViewDeciderProps = SafeAreaViewDeciderDefaultProps, totalNumberOfProgressBars = 5, blink = true, durationForTheBlink = 500, hideProgressBar = false, }) => {
